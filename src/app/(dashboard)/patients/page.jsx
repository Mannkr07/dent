...
import PatientAppointmentHistory from "../../../components/appointmentHistory";
import Odontogram from "../../../components/odontogram";

const Patients = () => {
  const [selectedTeeth, setSelectedTeeth] = useState([]);

  // This function will handle the tooth selection change
  const handleToothClick = (toothNumber) => {
    ...
    setSelectedTeeth((prevSelectedTeeth) => {
      if (prevSelectedTeeth.includes(toothNumber)) {
        ...
        return prevSelectedTeeth.filter((tooth) => tooth !== toothNumber);
      } else {
          ...
          <TabsContent value="patient-information" className="mt-4">
            ...
            <Card className="mt-4">
              ...
              <CardContent className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <h3 className="text-sm text-gray-500">
                    How many time, in a day, do you wash your teeth?
                  </h3>
                  <p>Twice</p>
                </div>
                <div>
            ...
            <Card className="mt-4">
              ...
              <CardContent className="grid grid-cols-3 gap-4">
                {[
                  {
                    src: "/placeholder.svg",
                    name: "Med_Pic_2131.jpg",
                    action: "Add notes",
                  },
                  {
                    src: "/placeholder.svg",
                    name: "Med_Pic_2132.jpg",
                    action: "Patient tooth shape",
                  },
                  {
                    src: "/placeholder.svg",
                    name: "Med_Pic_2133.jpg",
                    action: "Add notes",
                  },
                ].map((image, index) => (
                  <div
